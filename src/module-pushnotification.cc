    ...
    [](GenericStruct& moduleConfig) {
	    ...
	    ConfigItemDescriptor items[] = {
	        ...
	        {String, "external-push-uri",
	         ...
	         " - $app-id: An identifier for the application. On Android, it equals the value of 'pn-param'. On Apple, "
	         "it matches the string between the first and last periods of 'pn-param'. For example, if 'pn-param' is "
